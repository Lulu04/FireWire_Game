...
PROJECT_DIR="/media/sf_Pascal/FireWire_Game"
PROJECT_BINARY_DIR="${PROJECT_DIR}/Binary"
PROJECT_EXECUTABLE="${PROJECT_BINARY_DIR}/FireAndWire"
LAZARUS_PROJECT="${PROJECT_DIR}/FireAndWire.lpi"
STAGING_DIR=./staging
STAGING_EXECUTABLE="${STAGING_DIR}/FireAndWire"
NO_INSTALL_ARCHIVE_NAME="fireandwire_${VERSION}_${OS_NAME}_${WIDGETSET}.tar.gz"
